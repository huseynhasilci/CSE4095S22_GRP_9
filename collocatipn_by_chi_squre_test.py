...
def get_chi_square_information_values(tagged_unigram, tagged_bigram, document_total_size):
    ...
    for i in tagged_bigram:
        ...
        word_1 = i[0][0]
        word_2 = i[0][1]
        for j in tagged_bigram:
            if word_1 != j[0][0] and word_2 == j[0][1]:
                word_1_counter += 1
            elif word_1 == j[0][0] and word_2 != j[0][1]:
                word_2_counter += 1

        calculate_chi_square_test(word_1, word_2, bigram_words, word_1_counter, word_2_counter, bigram_freq, document_total_size)
        word_1_counter = 0
        word_2_counter = 0
